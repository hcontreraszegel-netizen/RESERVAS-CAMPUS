...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if p.path == '/':
            ...
            </section>{locked}<section class="experience-section home-experiences"><div class="experience-heading"><span>ELIGE TU EXPERIENCIA</span><b>Un toque y estás dentro</b></div>{activity_cards_html()}</section><section class="viva-promise"><b>Reserva. Participa. VIVE.</b><span>Elige tu espacio: deportes por horario y laboratorios disponibles de lunes a viernes, de 9 a. m. a 10 p. m.</span></section>'''
